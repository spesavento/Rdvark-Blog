...
-- 4. Which country has a population that is more than Canada but less than Poland? Show the name and the
-- population.
...
name = 'Germany'), 0), '%') AS pop_per FROM world
WHERE continent = 'Europe';

-- 6. Which countries have a GDP greater than every country in Europe? [Give the name only.] (Some countries
-- may have NULL gdp values)
SELECT name FROM world
...
-- 10. Some countries have populations more than three times that of any of their neighbours (in the same
-- continent). Give the countries and continents.
